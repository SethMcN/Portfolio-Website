...
window.addEventListener("resize", () => [canvas.width, canvas.height] = [Window.width,Window.height], false);
...
function animate() {
    ...
    Math.random() < .1 && fireworks.push(new Firework());  //Controlling the number of fireworks
